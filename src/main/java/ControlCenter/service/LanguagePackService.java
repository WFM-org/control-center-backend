...
import ControlCenter.entity.compositeKey.LanguagePackEnabledId;
...
public class LanguagePackService {
    ...
    public void assignLanguagePack(UUID tenantId, String languagePackId) throws TenantNotFoundException, LanguagePackAlreadyAssignedException, LanguagePackNotFoundException {
        ...
        Optional<LanguagePackEnabled> existId = languagePackEnabledRepository.findById(new LanguagePackEnabledId(languagePackId, tenant.getInternalId()));
        ...
        languagePackEnabled.setId(new LanguagePackEnabledId(languagePack.getInternalId(), tenant.getInternalId()));
    ...
    public void unassignLanguagePack(String languagePackId, UUID tenantId) throws TenantNotFoundException, LanguagePackNotFoundException {
        Tenant tenant = tenantRepository.findById(tenantId)
                .orElseThrow(() -> new TenantNotFoundException(tenantId));
        LanguagePackEnabled byId = languagePackEnabledRepository.findById(new LanguagePackEnabledId(languagePackId, tenant.getInternalId()))
                .orElseThrow(() -> new LanguagePackNotFoundException(languagePackId, tenantId));
