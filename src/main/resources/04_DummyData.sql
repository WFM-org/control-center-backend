...
VALUES
 ...
 INSERT INTO Employment (tenant,person,employee_Id,username,password,email,primary_Employment)
VALUES
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLINGTEST'),(SELECT internal_id FROM Person WHERE person_Id = '12345678' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLINGTEST')),'12345678','jsmith','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','jsmith@company.com',true),
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLING'),(SELECT internal_id FROM Person WHERE person_Id = '12345678' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLING')),'12345678','jsmith','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','jsmith@company.com',true),
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'DSVTEST'),(SELECT internal_id FROM Person WHERE person_Id = '12345678' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'DSVTEST')),'12345678','jsmith','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','jsmith@company.com',true),
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'DSV'),(SELECT internal_id FROM Person WHERE person_Id = '12345678' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'DSV')),'12345678','jsmith','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','jsmith@company.com',true),
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLINGTEST'),(SELECT internal_id FROM Person WHERE person_Id = '12345676' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLINGTEST')),'12345676','cgrant','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','cgrant@company.com',true),
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLING'),(SELECT internal_id FROM Person WHERE person_Id = '12345676' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLING')),'12345676','cgrant','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','cgrant@company.com',true),
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'DSVTEST'),(SELECT internal_id FROM Person WHERE person_Id = '12345676' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'DSVTEST')),'12345676','cgrant','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','cgrant@company.com',true),
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'DSV'),(SELECT internal_id FROM Person WHERE person_Id = '12345676' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'DSV')),'12345676','cgrant','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','cgrant@company.com',true),
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLINGTEST'),(SELECT internal_id FROM Person WHERE person_Id = '12345675' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLINGTEST')),'12345675','admin','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','admin@company.com',true),
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLING'),(SELECT internal_id FROM Person WHERE person_Id = '12345675' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'SALLING')),'12345675','admin','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','admin@company.com',true),
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'DSVTEST'),(SELECT internal_id FROM Person WHERE person_Id = '12345675' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'DSVTEST')),'12345675','admin','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','admin@company.com',true),
    ((SELECT internal_id FROM Tenant WHERE tenant_id = 'DSV'),(SELECT internal_id FROM Person WHERE person_Id = '12345675' and tenant = (SELECT internal_id FROM Tenant WHERE tenant_id = 'DSV')),'12345675','admin','$2a$10$Qz0K9e/pO99pvSVxzHFtmuyxdr7xd/4EfRFSUDDFXLvY5s6E6TdGe','admin@company.com',true);

INSERT INTO Employment_History (employment,start_Date,event,employee_Status,company,manager,hr,orgunit,cost_center,timezone)
VALUES
